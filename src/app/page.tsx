    ...
    <main className="max-w-5xl mx-auto p-6">
      ...
      <section className="pt-6 pb-8">
        ...
        <p className="mt-3 text-neutral-300 leading-relaxed max-w-3xl">
          Back-of-house tools for small kitchens: inventory, recipes, menu costing, sales &amp; expenses, and a built-in dashboard.
          Designed for owner-operators who want numbers they can trust without hiring a data team.
        </p>
        ...
        <p className="mt-3 text-xs text-neutral-400 max-w-2xl">
          No credit card required for the Starter plan during beta. If you find a bug or something feels confusing, you&apos;re helping shape
          the product—just let us know and we&apos;ll fix it as soon as possible.
        </p>
      </section>
      ...
      <section className="mt-6">
        ...
        <p className="mt-2 text-sm text-neutral-400 max-w-3xl">
          All of these modules are wired together for a single tenant: import your data once and see it reflected across recipes, menu pricing,
          and the dashboard.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-4">
          ...
          <CTACard
            href="/staff/manage"
            title="Staff →"
            blurb="Manage staff roster, schedules, and payroll (Pro plan)."
          />
        </div>
      </section>
      ...
      <section className="mt-10">
        ...
        <p className="mt-2 text-sm text-neutral-400 max-w-3xl">
          You can start on Starter and upgrade later—your data comes with you. Starter helps you get set up, Basic helps you understand trends,
          and Pro helps you run the business with premium tools and controls.
        </p>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-3 text-sm">
          ...
          <div className="rounded-lg border border-neutral-800 p-4">
            ...
            <div className="mt-2 text-xs text-neutral-400">Get set up and learn the workflow.</div>
            <ul className="mt-3 space-y-1 text-xs text-neutral-300">
              <li>• 1 location</li>
              <li>• Inventory, Recipes, Menu, Sales, Expenses</li>
              <li>• Dashboard basics (up to 3 months of history)</li>
              <li>• CSV imports + manual entry</li>
              <li>• Optional demo data mode (read-only)</li>
            </ul>
          </div>
          ...
          <div className="rounded-lg border border-emerald-700 p-4 bg-emerald-900/10">
            ...
            <div className="mt-2 text-xs text-neutral-200">Understand performance with trends and exports.</div>
            <ul className="mt-3 space-y-1 text-xs text-neutral-200">
              <li>• Everything in Starter</li>
              <li>• Unlimited history</li>
              <li>• Receipt photo upload</li>
              <li>• Trend views (day/week/month)</li>
          ...
          <div className="rounded-lg border border-neutral-800 p-4">
            ...
            <div className="mt-2 text-xs text-neutral-400">Run the business with premium tools and controls.</div>
            <ul className="mt-3 space-y-1 text-xs text-neutral-300">
              <li>• Everything in Basic</li>
              <li>• Staff module (accounts, schedules, payroll)</li>
              <li>• Advanced dashboards &amp; comparisons</li>
              <li>• Customization options (logo, colors, print styling)</li>
      ...
      <section className="mt-10">
        ...
        <ul className="list-disc pl-5 mt-3 space-y-2 text-neutral-300">
          <li>Sales &amp; expenses views for daily, weekly, monthly, and year-to-date.</li>
          <li>Time-bucketed tables (day / ISO week / month / quarter / year) that match the UI labels.</li>
          <li>Top products and expense categories so you know what’s driving your numbers.</li>
        </ul>
        <div className="mt-4">
      ...
      <section className="mt-10">
        ...
        <ul className="list-disc pl-5 mt-3 space-y-2 text-neutral-300">
          ...
          <li>Some screens are still being refined (copy / spacing / visuals).</li>
          <li>We’re focused on making the core numbers rock-solid, then adding deeper insights over time.</li>
